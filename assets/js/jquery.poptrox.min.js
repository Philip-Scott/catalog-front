                            ...
                            setTimeout(function(){
                                ...
                                $('#purchase').bind("click",function(){
                                    ...
                                    if (("" + get ('purchase').innerHTML) != "Bought") {
                                        // FIXME: HIT API HERE
                                        console.log ((settings.caption)(a));

                                        fetch(`http://ec2-34-215-220-146.us-west-2.compute.amazonaws.com:8080/eventoid/${(settings.caption)(a)}`, {
                                            method: 'GET',
                                        }).then(res => res.json()
                                        ).then(event => {
                                            var data = {
                                                sessionId: 1,
                                                eventId: (settings.caption)(a),
                    ...
                    $this.find(settings.selector).each(function(index) {
                        ...
                        // Determine caption.
                            ...
                            // Function?
                                    ...
                                    c = "<button id='purchase'>Buy a Ticket<buy-id style='display: none;'>" + (settings.caption)(a) + "</id></button>";
                                }
