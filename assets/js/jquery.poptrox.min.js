                        ...
                        .on('poptrox_open', function(e, index) {
                            ...
                            setTimeout(function(){
                                ...
                                $('#purchase').bind("click",function(){
                                    console.log ($('Clicked'));
                                    if (("" + get ('purchase').innerHTML) != "Bought") {
                                        // FIXME: HIT API HERE
                                        console.log (ticket_event_id);

                                        fetch(`http://ec2-34-215-220-146.us-west-2.compute.amazonaws.com:8080/eventoid/${ticket_event_id}`, {
                                            method: 'GET',
                                        }).then(res => res.json()
                                        ).then(event => {
                                            var data = {
                                                cart_id: "1",
                                                item_id: 12345,
                                                createdAt: '2017-11-03 00:00:00',
                                                updatedAt: '2017-11-06 00:00:00',
                                                name: event.nombre,
                                            ...
                                            axios.post ("http://ec2-35-163-131-157.us-west-2.compute.amazonaws.com:3001/api/carts", data);
                                            window.location.assign ("http://ec2-35-163-131-157.us-west-2.compute.amazonaws.com/?user=1");
                                            /*
                                            fetch("http://ec2-35-163-131-157.us-west-2.compute.amazonaws.com:3001/api/carts", {
                                                headers: {
                                        ...
                                        get ('purchase').innerHTML = "Bought";
                                        console.log (get ('purchase').innerHTML);
                                    }                                     
                                });
                            }, 1000);
                        })
                    ...
                    $this.find(settings.selector).each(function(index) {
                        ...
                        // Determine caption.
                            ...
                            // No caption setting? Use default (title attribute of image).
                                if (!settings.caption) {
                                    c = i.attr('title');
                                    console.log (settings.caption);
                                }
    
                            // Function?
                                else if (typeof(settings.caption) == 'function') {
                                    //ticket_event_id = (settings.caption)(a);
                                    c = "<button id='purchase'>Buy a Ticket<buy-id style='display: none;'>" + ticket_event_id + "</id></button>";
                                }
